...
{
    if(toss==1)
        document.getElementById("bat").value = "CSK Batting";
    else
        document.getElementById("bat").value = "MI Batting";
}
var count1=0;
var count2=0;
var w1count=0;
...
{
    var team1Value = document.getElementById("team1goals").children;
    ...
    var team2Value = document.getElementById("team2goals").children;
